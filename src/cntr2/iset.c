...
inline void iset_insert(object obj, const_unknown __ref) {
	_interface _inf = (_interface)__cast((unknown)obj, ISET_ID);
	dbg_assert(_inf != NULL);
...
inline void iset_replace(object obj, const_unknown __ref) {
	_interface _inf = (_interface)__cast((unknown)obj, ISET_ID);
	dbg_assert(_inf != NULL);
...
inline bool iset_contains(const_object obj, const_unknown __ref) {
	_interface _inf = (_interface)__cast((unknown)obj, ISET_ID);
	dbg_assert(_inf != NULL);
...
inline bool iset_remove(object obj, const_unknown __ref) {
	_interface _inf = (_interface)__cast((unknown)obj, ISET_ID);
	dbg_assert(_inf != NULL);
...
inline void iset_itr_find(const_object obj, iterator itr, const_unknown __ref) {
	_interface _inf = (_interface)__cast((unknown)obj, ISET_ID);
	dbg_assert(_inf != NULL);
...
inline void imset_insert(object obj, const_unknown __ref) {
	_interface _inf = (_interface)__cast((unknown)obj, IMSET_ID);
	dbg_assert(_inf != NULL);
...
inline bool imset_contains(const_object obj, const_unknown __ref) {
	_interface _inf = (_interface)__cast((unknown)obj, IMSET_ID);
	dbg_assert(_inf != NULL);
...
inline int imset_count(const_object obj, const_unknown __ref) {
	_interface _inf = (_interface)__cast((unknown)obj, IMSET_ID);
	dbg_assert(_inf != NULL);
...
inline int imset_remove(object obj, const_unknown __ref) {
	_interface _inf = (_interface)__cast((unknown)obj, IMSET_ID);
	dbg_assert(_inf != NULL);
...
inline void imset_itr_find_lower(const_object obj, iterator itr, const_unknown ref) {
	_interface _inf = (_interface)__cast((unknown)obj, IMSET_ID);
	dbg_assert(_inf != NULL);

	((struct imset_vtable*)(_inf->__vtable))->__itr_find_lower(obj, itr, ref);
}
inline void imset_itr_find_upper(const_object obj, iterator itr, const_unknown ref) {
	_interface _inf = (_interface)__cast((unknown)obj, IMSET_ID);
	dbg_assert(_inf != NULL);
